...
{#each datas_information as data_info,idx}
    ...
    {#if data_info.id.video}
        ...
        <a href={data_info.id.link_download} target="_blank" rel="noreferrer" class="inline-block px-4 py-2 mt-2 text-white bg-blue-600 rounded hover:bg-blue-700">download informasi rahasia</a>
    {/if}
